...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tensor-sensor-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14162&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tensor-sensor-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tensor-sensor` can be installed with:

```
conda install tensor-sensor
```

It is possible to list all of the versions of `tensor-sensor` available on your platform with:
